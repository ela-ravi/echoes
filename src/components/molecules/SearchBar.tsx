...
const SearchBar: React.FC<SearchBarProps> = ({ placeholder = "Search" }) => (
  <label className="flex w-full">
    <span className="flex items-center justify-center rounded-l-xl bg-[#282d43] px-4 text-[#99a0c2]">
      <Icon size={20}>
    ...
    <input
      ...
      className="flex-1 rounded-r-xl bg-[#282d43] px-4 text-white placeholder:text-[#99a0c2] focus:outline-none"
    />
  </label>
);
