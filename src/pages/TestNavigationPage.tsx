  ...
  return (
    <div className="min-h-screen bg-[#0a0e17] text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 p-6 bg-[#131520] rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Navigation Card */}
          <div className="bg-[#1d2030] p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
        ...
        <div className="mt-12 p-6 bg-[#1d2030] rounded-lg">
          <h2 className="text-xl font-semibold mb-4">Navigation Tester</h2>
          <div className="flex flex-col space-y-4">
            <input
              type="text"
              placeholder="Enter news ID"
              className="px-4 py-2 bg-[#131520] border border-[#394060] rounded text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              value={newsId}
